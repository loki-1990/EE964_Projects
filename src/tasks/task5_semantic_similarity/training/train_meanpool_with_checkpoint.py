...
from src.tasks.task5_semantic_similarity.evaluation.eval_meanpool_temporal import (
    eval_meanpool_temporal_retrieval,
)
...
def train_meanpool_with_checkpoint(
    model,
    train_loader,
    val_loader,
    optimizer,
    ...
    """
    Train meanpool temporal model with:
