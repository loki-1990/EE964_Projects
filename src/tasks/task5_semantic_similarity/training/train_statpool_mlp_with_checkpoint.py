...
from src.tasks.task5_semantic_similarity.training.train_statpool_mlp import (
    train_one_epoch_statpool_mlp,
)
from src.tasks.task5_semantic_similarity.evaluation.eval_statpool_mlp_checkpoint import (
    eval_statpool_mlp_retrieval,
)
...
def train_statpool_mlp_with_checkpoint(
    model,
    train_loader,
    val_loader,
    optimizer,
